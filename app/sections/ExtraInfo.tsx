...
const ExtraInfo = ({ planet }: ExtraInfoProps) => {
  return (
    <div className="h-full flex items-cente">
      <Card className="w-full h-fit p-4 flex flex-col gap-xs relative">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-body-primary">
            <span className="text-title font-bold">Lichtjaar</span> ≈ 9,46 bln.
            km (Afstand die licht in 1 jaar aflegt)
          </p>
        </div>
        ...
        <QrCode className="absolute bottom-4 right-4" />
      </Card>
    </div>
  );
};
